...
client.on("message", message => {
    if (message.content === (prefix + "help")) {
     const embed = new Discord.RichEmbed() 
         ...
         .setDescription(`**
         1-${prefix}bc : برودكاست لجميع اعضاء السيرفر بايمبد
         2-${prefix}ping : لعرض بنقك الحالي
         3-${prefix}skin : (minecraftusername) عرض سكنك في ماين كرافت        
         4-${prefix}clear : مسح الشات
         5-${prefix}temp لانشاء غرفة مؤقتة صوتية او كتابية
         6-${prefix}new لانشاء تذكرة
         7-${prefix}close لاغلاق التذكرة
         8-${prefix}avatar (mentionuser) لعرض صورة الشخص اللي منشنته
         9-${prefix}role (mentionuser) (rolename)
         10-${prefix}server لعرض معلومات السيرفر
         11-${prefix}simage لعرض صورة السيرفر
         12-${prefix}unvmute لفك الميوت الصوتي عن الشخص
         13-${prefix}content (messege) لارسال رسالة لمطور البوت او الابلاغ عن مشكلة
         14-${prefix}report للابلاغ عن شخص 
         15-${prefix}sug (sugget)  للاقتراح
         ------------------------------
         1-${prefix}help : عرض هذه الرسالة
